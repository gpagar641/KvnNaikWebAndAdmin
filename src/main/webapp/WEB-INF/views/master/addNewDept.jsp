					...
					<div class="row">
						...
						<div class="col-md-6 validation-grids widget-shadow"
							...
							<div class="form-body">
								...
								<form data-toggle="validator" method="post" action="${pageContext.request.contextPath}/submitAddDept">
									...
									<div class="form-group">
										<input type="text" class="form-control cust-mobile" id="contactNo" name="contactNo"
											placeholder="Department Contact no" required>
									</div>
